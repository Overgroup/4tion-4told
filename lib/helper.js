...
exports.processIncomingText = function (phoneNumber, message) {
    ...
    getRandomAnswer(function(answer) {
        var messageForTwitter = 'xxx-xxx-' + lastFourDigits + ' Q: ' + message;
        if(messageForTwitter.length > 85) {
            messageForTwitter = messageForTwitter.substring(0,82) + '...';
        }
        messageForTwitter = messageForTwitter + '? A:  ' + answer;
